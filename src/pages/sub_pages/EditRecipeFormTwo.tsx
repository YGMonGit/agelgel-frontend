  ...
  return (
    <div className="w-full flex-grow flex flex-col justify-start items-start mt-2">
      ...
      <div className="w-full px-5 flex flex-col justify-start items-start flex-grow my-5">
        <label htmlFor="ingredientQuantity" className="text-[1rem] font-semibold select-none">
          Ingredient Quantity
        </label>
        <div className="flex flex-wrap w-full justify-start items-start outline-none my-2 gap-2">
          <div className="flex flex-grow justify-start items-start border rounded-lg outline-none border-gray-300 dark:border-neutral-700 h-[40px]">
            <div
              className="h-full w-[40px] bg-content-color rounded-l-lg flex justify-center items-center text-white text-[1.2rem] select-none cursor-pointer"
            ...
            <div
              className="h-full w-[40px] bg-content-color rounded-r-lg flex justify-center items-center text-white text-[1.2rem] select-none cursor-pointer"
          ...
          <div
            className="h-[40px] flex-grow flex-gr px-3 gap-1 rounded-md flex justify-center items-center border border-content-color bg-content-color text-white text-[.85rem] leading-none select-none cursor-pointer"
...
export default EditRecipeFormTwo;